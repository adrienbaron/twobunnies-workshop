...
declare namespace cc {
    ...
    export class CardinalSplineTo extends ActionInterval {
         ...
         * @param {Number} tension
         */
        public constructor(duration:number, points:cc.Point[], tension:number);
        public constructor();
    ...
    export class CatmullRomTo extends CardinalSplineTo {
         ...
         */
        public constructor(dt:number, points:cc.Point[], tension:number);
        public constructor();
    ...
    export class CatmullRomBy extends CardinalSplineBy {
         ...
         * @param {Array} points
         */
        public constructor(dt:number, points:cc.Point[]);
        public constructor();
...
//    };
    ...
    export class Place extends ActionInstant {
         ...
         * @param {Number} [y]
         */
        public constructor(pos:cc.Point|number, y?:number);
        public constructor();
    ...
    export class CallFunc extends ActionInstant {
         ...
         * @param {*|null} [data] data for function, it accepts all data types.
         */
        public constructor(selector:CallFuncCallback, selectorTarget?:any, data?:any);
        public constructor();
  ...
  export function rotateBy(duration:number, deltaAngleX:number, deltaAngleY?:number):RotateBy;
    ...
    export class JumpBy extends ActionInterval {
         ...
         * @param {Number} jumps
         */
        public constructor(duration:number, position:number|cc.Point, y?:number, height?:number, jumps?:number);
        public constructor();
    ...
    export class BezierBy extends ActionInterval {
         ...
         * @param {Array} c Array of points
         */
        public constructor(duration:number, c:cc.Point[]);
        public constructor();
